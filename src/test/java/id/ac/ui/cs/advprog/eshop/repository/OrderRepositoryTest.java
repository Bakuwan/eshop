...
class OrderRepositoryTest {
    ...
    void setUp() {
        ...
        Order order1 = new Order("136525656-01a2-4c07-b546-5beb1396d79b",
                products, 1708560000L, "Safira Sudrajat");
        orders.add(order1);
        Order order2 = new Order("79fe15bb-4515-424b-a7e8-9acb8b09bf0c",
                products, 1708560000L, "Safira Sudrajat");
        orders.add(order2);
        Order order3 = new Order("43ef4e0f-984c-4967-bf32-8ea8697c9ef1",
